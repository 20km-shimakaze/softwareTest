package com.FlightJUnitFestSwing;/*
	...
	private  boolean ReadFlightFile()
	{
		...
		try{
			DataInputStream fm = new DataInputStream(new BufferedInputStream(
					new FileInputStream("src/main/java/com/FlightJUnitFestSwing/FlightInfo.txt")));
			//航班个数
	...
	public  boolean WriteFlightFile()
	{
		...
		try{
			DataOutputStream fm = new DataOutputStream(new BufferedOutputStream(
					new FileOutputStream("src/main/java/com/FlightJUnitFestSwing/FlightInfo.txt")));
			//航班个数
